 ...
 * This class is used mostly at the frontend of project.
...
{	
	...
	public function prepareContentValues()
	{
		...
		$version = $this -> model -> registry -> getInitialVersion();
		...
		foreach($this -> content as $field => $value)
		{
			...
			{
			    if($type == "char" && Registry :: instance() -> getSetting("DbEngine") == "mysql")
